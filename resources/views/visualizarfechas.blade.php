        ...
        <div class="fondoContenido letraTitulo">
            ...
            @if($shows)
                @foreach($shows as $show)
                    <div class="titulo">
                        <div class="row">
                            <img src="{{ asset('img/calendarioicono.jpg') }}" class="img-responsive fondoContenido col-sm-2" style="width:10%" alt="Image">
                            <div class="col-sm-10">
                                <div class="row">
                                <div class="col-sm-2 letraTitulo">Nombre:</div>
                                <div class="col-sm-3 letraTexto">{{$show->title}}</div>
                                ...
                                <div class="row">
                                <div class="col-sm-2 letraTitulo">Inicio</div>
                                ...
                                <div class="col-sm-2 letraTexto">{{substr($show->start, 11,5)}}</div>
                            </div>
                                <div class="row">
                                <div class="col-sm-2 letraTitulo">Termino</div>
                                <div class="col-sm-1 letraTitulo">Dia</div>
                                <div class="col-sm-2 letraTexto">{{substr($show->end, 0,10)}}</div>
                                <div class="col-sm-1 letraTitulo">Hora:</div>
                                <div class="col-sm-2 letraTexto">{{substr($show->end, 11,5)}}</div>
                            </div>
                                <div class="row">
